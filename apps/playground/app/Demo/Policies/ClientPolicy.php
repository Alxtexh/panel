...
/**
 * Client's policy, which has to NAME its model.
 *
 * `TenantResourcePolicy::modelFor()` derives the model from the policy's own
 * class name plus the application namespace - `ClientPolicy` guards
 * `App\Models\Client` - which is right for a conventional application and
 ...
 */
final class ClientPolicy extends TenantResourcePolicy
{
