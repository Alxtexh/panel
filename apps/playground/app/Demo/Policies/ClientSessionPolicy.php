...
/**
 * ClientSession's policy, which has to NAME its model.
 *
 * `TenantResourcePolicy::modelFor()` derives the model from the policy's own
 * class name plus the application namespace - `ClientSessionPolicy` guards
 * `App\Models\ClientSession` - which is right for a conventional application and
 ...
 */
final class ClientSessionPolicy extends TenantResourcePolicy
{
