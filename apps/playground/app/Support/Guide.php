    ...
    public static function pages(): array
    {
        return [
            ...
            'installation' => [
                ...
                'body' => [
                    'PanelKit needs PHP 8.4, Laravel 12 or 13, and Inertia with Vue 3. Two packages: `panelkit/panel` on the server and `@panelkit/ui` in the bundle. Both are required - the server package alone renders pages the client cannot draw.',
                    'The install command publishes the config, registers the service provider if package discovery has not, and prints what it did not do. Read that output: it names the decisions the package refuses to make for you, chiefly the tenancy mode.',
