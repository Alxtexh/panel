...
/*
 * The panel's BillingPortal screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import BillingPortal from '@alxtexh-enterprise/panel/pages/BillingPortal.vue';
...
<template>
    ...
    -->
    <BillingPortal v-bind="$attrs as any" />
</template>
