...
/*
 * The panel's BillingSuspended screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import BillingSuspended from '@alxtexh-enterprise/panel/pages/BillingSuspended.vue';
...
<template>
    ...
    -->
    <BillingSuspended v-bind="$attrs as any" />
</template>
