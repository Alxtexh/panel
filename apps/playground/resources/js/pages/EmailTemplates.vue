...
/*
 * The panel's EmailTemplates screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import EmailTemplates from '@alxtexh-enterprise/panel/pages/EmailTemplates.vue';
...
<template>
    ...
    -->
    <EmailTemplates v-bind="$attrs as any" />
</template>
