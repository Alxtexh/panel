...
/*
 * The panel's Environment screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import Environment from '@alxtexh-enterprise/panel/pages/Environment.vue';
...
<template>
    ...
    -->
    <Environment v-bind="$attrs as any" />
</template>
