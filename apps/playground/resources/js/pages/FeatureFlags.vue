...
/*
 * The panel's FeatureFlags screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import FeatureFlags from '@alxtexh-enterprise/panel/pages/FeatureFlags.vue';
...
<template>
    ...
    -->
    <FeatureFlags v-bind="$attrs as any" />
</template>
