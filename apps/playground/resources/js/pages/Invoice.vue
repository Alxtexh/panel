...
<template>
    ...
    <div class="p-4">
        ...
        <div class="mb-4 flex items-center justify-end gap-2 print:hidden">
            <button
                type="button"
                class="inline-flex items-center gap-2 rounded-md bg-primary px-3 py-1.5 text-sm text-primary-foreground transition-opacity hover:opacity-90"
                @click="print"
            >
                <svg
                    class="size-4"
        ...
        >
            <header class="flex items-start justify-between gap-8">
                <div>
                    ...
                    <p class="mt-1 font-mono text-sm text-neutral-600">
                        {{ invoice.number }}
                    </p>
                </div>
            ...
            <table class="mt-8 w-full text-sm">
                ...
                <tbody>
                    ...
                    <tr v-if="invoice.lines.length === 0">
                        ...
                        >
                            This subscriber has no plan, so there is nothing to
                            bill.
                        </td>
                    </tr>
                </tbody>
            ...
            <div class="mt-6 flex break-inside-avoid justify-end">
            ...
            <footer
                class="mt-10 border-t border-neutral-200 pt-4 text-xs text-neutral-500"
            >
                {{ invoice.terms }}
            </footer>
        </article>
