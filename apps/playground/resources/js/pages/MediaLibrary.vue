...
/*
 * The panel's MediaLibrary screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import MediaLibrary from '@alxtexh-enterprise/panel/pages/MediaLibrary.vue'
...
<template>
    ...
    -->
    <MediaLibrary v-bind="($attrs as any)" />
</template>
