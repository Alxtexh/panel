...
/*
 * The panel's Onboarding screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import Onboarding from '@alxtexh-enterprise/panel/pages/Onboarding.vue';
...
<template>
    ...
    -->
    <Onboarding v-bind="$attrs as any" />
</template>
