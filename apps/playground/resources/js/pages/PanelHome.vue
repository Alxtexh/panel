...
/*
 * The panel's PanelHome screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import PanelHome from '@alxtexh-enterprise/panel/pages/PanelHome.vue';
