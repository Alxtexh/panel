...
/*
 * The panel's ResourceView screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import ResourceView from '@alxtexh-enterprise/panel/pages/ResourceView.vue';
...
<template>
    ...
    -->
    <ResourceView v-bind="$attrs as any" />
</template>
