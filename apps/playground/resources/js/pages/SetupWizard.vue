...
/*
 * The panel's SetupWizard screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import SetupWizard from '@alxtexh-enterprise/panel/pages/SetupWizard.vue';
...
<template>
    ...
    -->
    <SetupWizard v-bind="$attrs as any" />
</template>
