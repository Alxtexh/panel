...
/*
 * The panel's TicketAnalysis screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import TicketAnalysis from '@alxtexh-enterprise/panel/pages/TicketAnalysis.vue';
...
<template>
    ...
    -->
    <TicketAnalysis v-bind="$attrs as any" />
</template>
