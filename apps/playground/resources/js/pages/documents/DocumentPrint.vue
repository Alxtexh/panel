...
/*
 * The panel's printable document screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import DocumentPrint from '@alxtexh-enterprise/panel/pages/documents/DocumentPrint.vue';
