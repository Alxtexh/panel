...
/*
 * The panel's BackupSettings screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import BackupSettings from '@alxtexh-enterprise/panel/pages/operations/BackupSettings.vue';
...
<template>
    ...
    -->
    <BackupSettings v-bind="$attrs as any" />
</template>
