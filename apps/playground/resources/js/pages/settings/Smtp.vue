...
/*
 * The panel's SMTP settings screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import Smtp from '@alxtexh-enterprise/panel/pages/settings/Smtp.vue';
