...
| Account menu | Profile (account area) and Log out. Settings is in the Settings sidebar group by default; `->sidebarSettings(false)` restores it under the avatar. Security is a settings tab, not a third dropdown row |
