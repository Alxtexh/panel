...
.e-css.e-btn.e-outline.e-success {
  background: transparent;
  border-color: rgb(45.75, 216.25, 137.2);
  color: rgb(45.75, 216.25, 137.2);
  border-color: #198754;
  color: #198754;
}
...
.e-css.e-btn.e-outline.e-info {
  background: transparent;
  border-color: rgb(59.5849802372, 213.4743083004, 244.4150197628);
...
.e-css.e-btn.e-outline.e-danger {
  background: transparent;
  border-color: rgb(235.0632911392, 139.9367088608, 149.0506329114);
  color: rgb(235.0632911392, 139.9367088608, 149.0506329114);
  border-color: #dc3545;
  color: #dc3545;
}
