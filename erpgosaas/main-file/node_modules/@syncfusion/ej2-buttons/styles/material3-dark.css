...
.e-chip-list.e-chip, .e-chip-list .e-chip {
  background: -webkit-gradient(linear, left bottom, left top, from(rgba(var(--color-sf-primary), 0.05)), to(rgba(var(--color-sf-primary), 0.05)));
  background: linear-gradient(0deg, rgba(var(--color-sf-primary), 0.05), rgba(var(--color-sf-primary), 0.05));
  -o-border-image: rgba(var(--color-sf-outline));
     border-image: rgba(var(--color-sf-outline));
  color: rgba(var(--color-sf-on-surface-variant));
}
