...
.e-fab.e-btn:focus {
  -webkit-box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.2), 0 -2px 15px -3px rgba(0, 0, 0, 0.1), 0 6px 10px rgba(0, 0, 0, 0.14), 0 0 0 2px rgba(255, 255, 255, 0.95), 0 0 0 4px #4f46e5;
          box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.2), 0 -2px 15px -3px rgba(0, 0, 0, 0.1), 0 6px 10px rgba(0, 0, 0, 0.14), 0 0 0 2px rgba(255, 255, 255, 0.95), 0 0 0 4px #4f46e5;
}
...
.e-speeddial-popup .e-speeddial-li:focus:not(.e-disabled) .e-speeddial-li-icon {
  background: #f3f4f6;
  border-color: #d1d5db;
  -webkit-box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 0 0 2px rgba(255, 255, 255, 0.95), 0 0 0 4px #4f46e5;
          box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 0 0 2px rgba(255, 255, 255, 0.95), 0 0 0 4px #4f46e5;
}
