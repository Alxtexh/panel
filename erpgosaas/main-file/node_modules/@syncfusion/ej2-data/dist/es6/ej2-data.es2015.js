import { isNullOrUndefined, getValue, merge, extend, Fetch } from '@syncfusion/ej2-base';
...
class DataManager {
     ...
     * @hidden
     */
    constructor(dataSource, query, adaptor, middlewares) {
        /** @hidden */
        this.dateParse = true;
        /** @hidden */
    ...
    */
    ...
    makeRequest(url, deffered, args, query) {
        ...
        const fnSuccess = (data, request) => {
            ...
            }).catch((e) => this.dataManagerFailure(e, deffered, args));
        };
     ...
     * @hidden
     */
    dataManagerFailure(e, deffered, args) {
        args.error = e;
        deffered.reject(args);
    }
    ...
    dofetchRequest(res, fetchFunc, changes) {
        ...
        if (!this.isCustomDataAdaptor(this.adaptor)) {
            let promise = this.useMiddleware(res);
            let fetch;
            promise.then((response) => {
                fetch = new Fetch(res);
                fetch.beforeSend = () => {
                ...
                res = fetch.send();
                res.catch((e) => true); // to handle the failure requests.
            }).catch((e) => this.dataManagerFailure(e, this.fetchDeffered, {}));
        }
        else {
