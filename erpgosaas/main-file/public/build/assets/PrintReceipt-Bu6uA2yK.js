import{c as f,b as o}from"./helpers-CCSs4vWm.js";import"./app-DrRV8vTb.js";import"./ui-CUd_MbMF.js";/* empty css            */const $=(a,i)=>{var s,p,d,r;const x=`
    <!DOCTYPE html>
    <html>
    <head>
    ...
    `,n=document.createElement("iframe");n.style.display="none",document.body.appendChild(n);const e=n.contentDocument||((p=n.contentWindow)==null?void 0:p.document);e&&(e.write(x),e.close(),(d=n.contentWindow)==null||d.focus(),(r=n.contentWindow)==null||r.print(),setTimeout(()=>{document.body.removeChild(n)},1e3))};export{$ as printReceipt};
