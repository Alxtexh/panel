import{a3 as d,a0 as l}from"./ui-CUd_MbMF.js";import{F as b,i as g,a as h,b as x}from"./index-B-S_H2S5.js";import{u as y}from"./useTranslation-DAF40g04.js";function k({events:i,onEventClick:r,onDateClick:a,onMonthChange:n}){const{t:o}=y(),[c,f]=d.useState(!1),s=d.useMemo(()=>i.map(e=>{new Date(e.startDate);const t=new Date(e.endDate),u=e.startDate!==e.endDate?new Date(t.getTime()+24*60*60*1e3).toISOString().split("T")[0]:void 0;return{id:e.id.toString(),title:e.title,start:e.startDate,end:u,allDay:!0,backgroundColor:e.color,borderColor:e.color,extendedProps:e}}),[i]),m=e=>{r==null||r(e.event.extendedProps)},p=e=>{a==null||a(new Date(e.dateStr))};return l.jsxs("div",{className:"fullcalendar-container",style:{overflow:"visible"},children:[l.jsx(b,{plugins:[g,h,x],initialView:"dayGridMonth",headerToolbar:{left:"prev,next today",center:"title",right:"dayGridMonth,timeGridWeek,timeGridDay"},events:s,height:"auto",eventClick:m,dateClick:p,datesSet:e=>{if(c){const t=e.start.toISOString().slice(0,7);n==null||n(t)}else f(!0)},dayMaxEventRows:3,moreLinkText:o("more"),allDayText:o("All day"),eventMaxStack:3}),l.jsx("style",{children:`
