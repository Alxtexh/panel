    ...
    <div class="container">
      <div class="site-navigation">
        <a href="/" class="logo m-0 float-left"
          >{{ logoName }}<span class="text-primary">.</span></a
        >
        ...
        >
          <li class="cta-button-outline" style="margin-right: 5px;"><a :href="loginHref">Sign in</a></li>
          <li class="cta-primary">
            <a :href="registerHref" :style="[{ backgroundColor: themeColor }]">Register</a>
          </li>
        </ul>
        <a
          href="#"
