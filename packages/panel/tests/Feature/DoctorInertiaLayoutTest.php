...
final class DoctorInertiaLayoutTest extends TestCase
{
    ...
    public function test_nullish_assign_in_resolve_is_a_problem(): void
    {
    ...
    public function test_doctor_reports_nullish_layout_wiring_on_disk(): void
    {
        ...
        try {
            file_put_contents(
                $path,
                file_get_contents(dirname(__DIR__).'/Fixtures/js/app.nullish.ts'),
            );
