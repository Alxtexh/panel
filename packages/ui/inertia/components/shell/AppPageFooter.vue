 ...
 * list. Those stay on the rail. This sits in document flow after the page, so
 * short screens still show it at the foot of the column (`mt-auto`) and long
 * screens scroll to it with the rest of the content.
 *
...
<template>
    <footer
        ...
        class="mt-auto border-t bg-background px-4 py-3 text-sm text-muted-foreground sm:px-6"
    >
