 ...
 */
export const CATALOGUE_GRID = 'grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3'

/** Same column rules with a tighter gap (directory-style link tiles). */
export const CATALOGUE_GRID_TIGHT = 'grid grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-3'

/**
 * Product / merch tiles: two-up on small screens, three on wide desktops.
 */
export const CATALOGUE_GRID_TILES = 'grid grid-cols-2 gap-4 sm:gap-5 xl:grid-cols-3'
