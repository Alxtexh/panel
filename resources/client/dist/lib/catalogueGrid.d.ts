 ...
 */
export declare const CATALOGUE_CONTAINER = "@container min-w-0";
export declare const CATALOGUE_GRID = "grid grid-cols-1 gap-3 @lg:grid-cols-2 @3xl:grid-cols-3";
/** Same column rules with a tighter gap (directory-style link tiles). */
export declare const CATALOGUE_GRID_TIGHT = "grid grid-cols-1 gap-2 @lg:grid-cols-2 @3xl:grid-cols-3";
/**
 * Product / merch tiles: same container column steps, slightly larger gap.
 */
export declare const CATALOGUE_GRID_TILES = "grid grid-cols-1 gap-4 @lg:grid-cols-2 @lg:gap-5 @3xl:grid-cols-3";
