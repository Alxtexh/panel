...
/*
 * The panel's CatalogItem screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import CatalogItem from '@alxtexh-enterprise/panel/pages/CatalogItem.vue'
...
<template>
    ...
    -->
    <CatalogItem v-bind="($attrs as any)" />
</template>
