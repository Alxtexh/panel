...
/*
 * The panel's CatalogRegister screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import CatalogRegister from '@alxtexh-enterprise/panel/pages/CatalogRegister.vue'
...
<template>
    ...
    -->
    <CatalogRegister v-bind="($attrs as any)" />
</template>
