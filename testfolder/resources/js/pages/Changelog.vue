...
/*
 * The panel's Changelog screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import Changelog from '@alxtexh-enterprise/panel/pages/Changelog.vue'
