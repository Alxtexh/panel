...
/*
 * The panel's ResourceForm screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import ResourceForm from '@alxtexh-enterprise/panel/pages/ResourceForm.vue'
...
<template>
    ...
    -->
    <ResourceForm v-bind="($attrs as any)" />
</template>
