...
/*
 * The panel's Monitoring screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import Monitoring from '@alxtexh-enterprise/panel/pages/operations/Monitoring.vue'
...
<template>
    ...
    -->
    <Monitoring v-bind="($attrs as any)" />
</template>
