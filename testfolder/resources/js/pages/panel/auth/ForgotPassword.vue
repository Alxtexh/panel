...
/*
 * The panel's ForgotPassword screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import ForgotPassword from '@alxtexh-enterprise/panel/pages/panel/auth/ForgotPassword.vue'
...
<template>
    ...
    -->
    <ForgotPassword v-bind="($attrs as any)" />
</template>
