...
/*
 * The panel's Payments screen, from @alxtexh-enterprise/panel/inertia.
 *
 ...
 */
import Payments from '@alxtexh-enterprise/panel/pages/settings/Payments.vue'
