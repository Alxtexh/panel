 ...
 *
 * GENERATED BY `make:panel admin --auth` AND YOURS TO EDIT. The screens and the
 ...
 * name and that URI; this is `admin.login` under `/`.
 */
/*
...
Route::group([], function (): void {
     ...
     * `panel.auth.admin.passwords` to false if this installation cannot send
